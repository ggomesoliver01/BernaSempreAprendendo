...
class Sinistrovalor {
  ...
  constructor() {
        ...
        try {
            ...
            await page.click('#collapseScheduling > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div:nth-child(2) > div > app-so-scheduling-with-contact > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.mb-sm-16 > app-date-input-field > div > div > div.input-group.form-group > input')
              ...
              await page.waitForTimeout(10000)
               ...
               await this.updateStatusSinistros(arr[i].id,DataInput);
               await this.updateGatilhoSinistros(arr[i].id); 
    ...
    async carregaOS(){
      ...
      WHERE IZ.id_emp IN (64,71,111,146)
      AND IZ.status = 88
    ...
    //     axios.post("https://gsplanaltec.com/GerenciamentoServicos/APIControle/insereDescStatusAtualizado", { id: id, status: 53 }, {
