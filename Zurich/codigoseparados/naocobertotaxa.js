  ...
  try{
    ...
    // for(let loop = 0; loop < 250;) {
      ...
      dados[iDados] = {
        ...
        fs.writeFileSync('naocobertotaxa.json', JSON.stringify(dados).trim());
        console.log(dados);
...
envia() {
  ...
  var content = JSON.parse(fs.readFileSync("naocobertotaxa.json"));
  axios
    .post(
