    ...
    return response[0];
      ...
      removeDuplicates(originalArray, prop) {
        ...
        for(var i in originalArray) {
          lookupObject[originalArray[i][prop]] = originalArray[i];e
        }
