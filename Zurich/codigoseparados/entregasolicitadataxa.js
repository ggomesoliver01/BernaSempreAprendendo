...
class entregasolicitada {
  ...
  constructor() {
    ...
    posts = await rep.carregaOS(); // Assuming the method carregaOS is defined in the Sinistrovalor class
    await rep.listagem(page, browser, posts, i); // Using "this" to refer to the class methods
}
    ...
    //       GROUP BY IZ.id` //AND IZ.OS = '3790152'
...
const rep = new entregasolicitada();
rep.importaZurich();