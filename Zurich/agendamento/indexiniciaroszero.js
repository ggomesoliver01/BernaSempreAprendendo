...
class statusreparo{
 ...
 async importaZurich(i = 0, arr = []) {
    ...
    async listagem(page,browser, arr = [], i = 0){
        try{
          ...
          switch (status) {
            ...
            case 88:  // PENDENTE DE AGENDAMENTO
            
                console.log("PENDENTE DE AGENDAMENTO")
                ...
                if(Status == 'Nova' && Etapa == 'Iniciar OS') {
                    ...
                    await page.waitForSelector('#collapseStartAdd > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > app-start-add > div > div > div > div:nth-child(4) > app-dropdown-field > div.btn-group.d-flex.flex-column.show > div > a')
                    await page.click('#collapseStartAdd > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > app-start-add > div > div > div > div:nth-child(4) > app-dropdown-field > div.btn-group.d-flex.flex-column.show > div > a')
                ...
                await page.waitForTimeout(6000)  
                console.log('aqiui')
                await page.type('#collapseScheduling > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div:nth-child(1) > div > div:nth-child(1) > div.col-md-6.col-sm-12.value.mb-sm-16 > app-date-input-field > div > div > div.input-group.form-group', DataInput)
                ...
                await page.click('#collapseScheduling > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div:nth-child(2) > div > app-so-scheduling-with-contact > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.mb-sm-16 > app-date-input-field > div > div > div.input-group.form-group > input')
                  await page.waitForTimeout(2000)
                  await page.type('#collapseScheduling > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div:nth-child(2) > div > app-so-scheduling-with-contact > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.mb-sm-16 > app-date-input-field > div > div > div.input-group.form-group > input', DataInput )
                  ...
                  await page.click('#collapseProductWithdraw > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.d-flex.flex-column.ng-star-inserted > app-date-input-field > div > div')
                    await page.type('#collapseProductWithdraw > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.d-flex.flex-column.ng-star-inserted > app-date-input-field > div > div', DataInput)
                      ...
                      await page.waitForSelector('#collapseProductWithdraw > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column.show > div > a')
                      await page.click('#collapseProductWithdraw > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column.show > div > a')
                  ...
                  await page.waitForTimeout(10000)
                   //  
                   console.log(id,statusNovo)
                   console.log("StatusNovo:", statusNovo, "Status:", status)
                   await this.updateStatusSinistros88(arr[i].id,DataInput);
                   await this.updateGatilhoSinistros88(arr[i].id); 
                   await this.acaoControle.criarDesc(id,statusNovo,status)
                   await this.acaoControle.gatilhoStatus(arr[i].id,statusNovo);
                   await this.acaoControle.criarAG (id,statusNovo,DataInput,arr[i].id_emp)
                   await this.acaoControle.criarDescAG (id,DataInput)
                 ...
                 await page.waitForTimeout(5000)
                  ...
                  if(Status == 'Nova'  && Etapa == 'Agendar Reparo'){ 
                ...
                if(Status == 'Nova'  && Etapa == 'Receber Produto'){
                  console.log(DataInput)
                      console.log('aqui')
                  await page.waitForSelector('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.d-flex.flex-column.ng-star-inserted > app-date-input-field > div > div > div.input-group.form-group > input')
                    await page.click('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.d-flex.flex-column.ng-star-inserted > app-date-input-field > div > div > div.input-group.form-group > input')
                    await page.type('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.d-flex.flex-column.ng-star-inserted > app-date-input-field > div > div > div.input-group.form-group > input', DataInput)
                    await page.waitForSelector('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column')
                    await page.click('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column')
                    await page.waitForSelector('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column.show > div > a')
                    await page.click('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column.show > div > a')
                    await page.waitForSelector('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(4) > app-text-input-field > div.form-group > input')
                    await page.click('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(4) > app-text-input-field > div.form-group > input')
                    await page.type('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(4) > app-text-input-field > div.form-group > input', '000')
                    await page.waitForTimeout(2000)
                    await page.waitForSelector('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div.col-md-6.col-sm-12.ng-star-inserted > div > div > button')
                    await page.click('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div.col-md-6.col-sm-12.ng-star-inserted > div > div > button')
                    // await this.insetDescStatusSinistro(arr[i].id);
                    console.log(id,statusNovo)
                    console.log("StatusNovo:", statusNovo, "Status:", status)
                   await this.updateStatusSinistros88(arr[i].id,DataInput);
            ...
            if (Status == 'Nova' && Etapa == 'Receber Produto'){
              ...
              await page.waitForSelector('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.d-flex.flex-column.ng-star-inserted > app-date-input-field > div > div > div.input-group.form-group > input')
              await page.click('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.d-flex.flex-column.ng-star-inserted > app-date-input-field > div > div > div.input-group.form-group > input')
              await page.type('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div.col-12.col-sm-12.col-md-6.col-lg-6.value.d-flex.flex-column.ng-star-inserted > app-date-input-field > div > div > div.input-group.form-group > input', todayDate)
              await page.waitForSelector('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column')
              await page.click('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column')
              await page.waitForSelector('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column.show > div > a')
              await page.click('#collapseProductReceipt > app-loading > div.colored-card-background.card-alignment.ng-star-inserted > div > div:nth-child(1) > div > div:nth-child(2) > app-dropdown-field > div.btn-group.d-flex.flex-column.show > div > a')
  ...
  envia() {
    ...
    var content = JSON.parse(fs.readFileSync("indexfinalizacaotaxa.json"));
    axios
      .post(
  ...
  async carregaOS(){
    const response = await this.acaoModel.manualQuery({
      ...
      IZ.status,
      S.sel_nome,
      (SELECT D.desc_descricao FROM descricoes D where D.desc_id_zurich = IZ.id AND taxa_flet = 0 AND D.desc_descricao LIKE CONCAT('%', S.sel_nome, '%') order by D.desc_id desc limit 1) as 'descricao'
    FROM importados_zurich IZ
        left join selects S ON S.sel_id = IZ.status 
    WHERE IZ.id_emp IN (64,71,111,146,1)
    AND IZ.status IN (15,18,60,88,167)
    AND AtivoInativo in (1,3)
    AND taxa_Flet = 0
    ...
    return response[0];
      ...
      async updateDataSinistros(A_Rota,A_id_Zurich,A_Data,id_emp,id_user,status_id) {
        axios.post("https://gsplanaltec.com/consultaBot/",
        {
        sqlQuery:`INSERT INTO agendamento (A_Rota,A_id_Zurich,A_Data,id_emp,id_user,status_id) VALUES ('${A_Rota}','${A_id_Zurich}','${A_Data}','${id_emp}','${id_user}','${status_id}')`
        },
        {
        headers: {
            "Content-Type": "application/json; charset=UTF-8",
      ...
      async updateStatusSinistros88(id) {
          axios.post("https://gsplanaltec.com/consultaBot/",
          {
      ...
      async updateGatilhoSinistros88(id) {
          axios.post("https://gsplanaltec.com/consultaBot/",
          {
