...
class Vinculacao {
    ...
    //Login
    await page.type("#formulario\\:usuario", "MGC038")
    await page.waitForTimeout(2000)
    await page.click("#formulario\\:senha")
    await page.waitForTimeout(1000)
    //Senha (Manutenções nessa senha)
    await page.type("#formulario\\:senha", "bkJEe5n0")
    await page.waitForTimeout(2000)
    ...
    async exportaPlanilha(linha = 1, coluna, ) {
        ...
        fs.writeFileSync("dadosmarrom.json", JSON.stringify(dados).trim());
        console.log(dados);
        linha++;
    ...
    removeDuplicates(originalArray, prop) {
      ...
      async enviaOs(){
        ...
        //return;
        var content = JSON.parse(fs.readFileSync("dadosmarrom.json"));
