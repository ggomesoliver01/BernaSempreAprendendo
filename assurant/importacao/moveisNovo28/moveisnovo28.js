...
class Vinculacao {
    ...
    await page.select('#assistenciaSelect', "MGC037");
    ...
    async exportaPlanilha(linha = 1, coluna, ) {
        ...
        fs.writeFileSync("dadosmoveisnovo.json", JSON.stringify(dados).trim());
        console.log(dados);
        linha++;
    ...
    removeDuplicates(originalArray, prop) {
      ...
      async enviaOs(){
        ...
        //return;
        var content = JSON.parse(fs.readFileSync("dadosmoveisnovo.json"));
