...
class Vinculacao {
    ...
    await page.type("#formulario\\:senha", "qqB31irT")
    await page.waitForTimeout(2000)
    ...
    await page.waitForSelector('#rightIconformularioMenu\\:menuAtendimento')
    await page.click('#rightIconformularioMenu\\:menuAtendimento')
    console.log("Menu atendimento selecionado!")
    await page.waitForTimeout(3000)
    ...
    await page.waitForTimeout(2000);
    await page.click("#row_formularioMenu\\:menuAtendimento")
    await page.waitForTimeout(2000)
    await page.waitForTimeout(6000)
    ...
    async exportaPlanilha(linha = 1, coluna) {
        ...
        dados[iDados].cidade = dados[iDados].cidade.normalize('NFD').replace(/[\u0300-\u036f]/g, "").replace(/'/g, '`');
        ...
        fs.writeFileSync("dados233.json", JSON.stringify(dados).trim());
        console.log(dados);
        linha++;
    ...
    removeDuplicates(originalArray, prop) {
      ...
      async enviaOs(){
        ...
        //return;
        var content = JSON.parse(fs.readFileSync("dados233.json"));
