...
class importacaoconserto {
    ...
    (async () => {
      ...
      await page.waitForTimeout(10000)
           ...
           // DOWNLOAD
            ...
            await page.goto('http://zews.zurich.com.br/PortalPrestador/service-orders?service=2&periodCreated=7')
  ...
  carregaExcel(dadosTerminal){
    ...
    xlData.forEach(element => {
      ...
      //   var opcoesProdutos = [
      //       'AIRFRYER', 'AIR FRYER', 'APARADOR DE GRAMA', 'ASSADOR', 'BATED', 'BAT 4VEL', 'BAT 8VEL',
      //       'BAT PLAN', 'BATED.', 'BATEDEIRA', 'BIC', 'BIC.', 'BICICLETA', 'BICI', 'CAF', 'CAFET.',
      //       'CAFETEIRA', 'MAQ CAFE', 'MAQ. CAFE', 'MAQ.CAFE', 'NESPRESSO', 'TRES CORACOES VERSA',
      //       'CAIXA ACUSTICA', 'CARRINHO', 'CELULAR', 'CILINDRO', 'CHURRASQUEIRA', 'MULTIMIX',
      //       'COMPRESSOR', 'CORTADOR DE GRAMA', 'ELETROSERRA', 'ESMERILHADEIRA', 'CLOUD WALKER',
      //       'DIGITAL IB=VERTER', 'EASY WAY GENIS', 'EST ELET', 'EST ELETRONICA', 'ESTEIRA', 'GENIS',
      //       'EXTRATOR', 'EXTRATORA', 'PHILIPS FERRO PERFECTCARE', 'FRIT ELET', 'FRITADEIRA',
      //       'FURADEIRA', 'INVERSOR DE SOLDA', 'INVERSOR DIG', 'INVERSOR SOLDA', 'LAMINADOR',
      //       'LIQUIDIFICADOR', 'LIQ', 'LIQUID', 'OSTER NEW REVERSE', 'SOPEIRA', 'LIXADEIRA', 'MAKITA',
      //       'MAQUINA DE COSTURA', 'M.COST.', 'MAQ COSTURA', 'MAQUINA DE COSTURA', 'MA QUINA COSTURA',
      //       'COSTURA', 'MARTELETE', 'MICRO RETIFICA', 'KIT MULTIUSO', 'MOTOBOMBA', 'MOTOCOMPRESSOR',
      //       'MOTOESMERIL', 'MOTOSERRA', 'CENTRIFUGA DE FRUTAS', 'KIT CREATIVE GOURMET', 'MULTIPRO.',
      //       'MULTIPROC', 'MULTIPROCESSADOR', 'NUTRI NINJA', 'PROCESSADOR', 'MULTICHEF', 'SHARK NUTRI',
      //       'PAN ELET', 'PLAINA ELETRICA', 'PANIFICADORA', 'PARAFUSADEIRA', 'PARAFU FURAD',
      //       'PISTOLA PINTURA', 'PISTOLA PULVERIZADORA', 'POLITRIZ', 'PRAN GAMA', 'ROCADEIRA',
      //       'SECADOR', 'SERRA CIRCULAR', 'SERRA', 'SOVADEIRA', 'TABLET', 'SOPRADOR', 'CAIXA ACUSTICA PCX6500 380W PHILCO',
      //       'OSTER CAFETEIRA PRIMALATTE NEW XPER','SOUNDBAR PSB05 320W RMS PHILCO','MULTIPROCESSADOR MPN-01-BE MONDIAL UN',
      //       'BAT PLAN 11VEL PHILCO PHP500 PR C/ TIG INOX 220V','CAFETEIRA DOLCE GUSTO GENIO S PLUS VM DGS3 ARNO','BELICHE CONQUISTA LUCCA CHUMBO FOS/AMENDOA FOS.',
      //       'CAMA AUXILIAR P/ COL 088 CONQUISTA UNIVERSAL AMEND','OSTER NEW REVERSE RED - 220V','MULTIPROCESSADOR MPN-01-BE MONDIAL UN',
      //       'TORRE SOM 1500W MONDIAL CM12 SC BTH USB FM W2X12','MULTIPROCESSADOR PMP1600 VERM PHILCO','MULTIPROCESSADOR MPN-01-BE MONDIAL UN',' 	BAT PLAN 11VEL PHILCO PHP500 PR C/ TIG INOX 110V',
            
      //   ];
        
        
      //   if (opcoesProdutos.includes(colunas.NomedoProduto)) {
      //     emp = 146;
      // }
    ...
    fs.writeFileSync('dadosSalvos.json', JSON.stringify(dados).trim());
        console.log(dados);
  ...
  async enviaOs(){
    ...
    //return;
    var content = JSON.parse(fs.readFileSync("dadosSalvos.json"));
