...
class importacaomoveis {
  ...
  importaZurich(dadosTerminal) {
    ...
    (async () => {
      ...
      await page.waitForTimeout(10000)
           ...
           // DOWNLOAD
            await page.goto('http://zews.zurich.com.br/PortalPrestador/service-orders?service=69&periodCreated=1')
  ...
  carregaExcel(dadosTerminal){
    ...
    fs.writeFileSync('troca.json', JSON.stringify(dados).trim());
        console.log(dados);
  ...
  async enviaOs(){
    ...
    //return;
    var content = JSON.parse(fs.readFileSync("troca.json"));
